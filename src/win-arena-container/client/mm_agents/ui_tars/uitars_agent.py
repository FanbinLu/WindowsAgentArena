...
from mm_agents.ui_tars.prompts import (
    UITARS_ACTION_SPACE,
...
class UITARSAgent:
    ...
    def predict(
        ...
        if prediction is None:
            logs['plan_result'] = "client error"
            return "client error", ["DONE"], logs, computer_update_args

        logs['plan_result'] = prediction
        ...
        try:
            ...
            print(f'parsed_responses: {parsed_responses}')
        except Exception as e:
        ...
        for parsed_response in parsed_responses:
            if "action_type" in parsed_response:
                ...
                if parsed_response["action_type"] == FINISH_WORD:
                    ...
                    return prediction, ["DONE"], logs, computer_update_args
                
                elif parsed_response["action_type"] == WAIT_WORD:
                    self.actions.append(actions)
                    return prediction, ["WAIT"], logs, computer_update_args
                
                elif parsed_response["action_type"] == ENV_FAIL_WORD:
                    self.actions.append(actions)
                    return prediction, ["FAIL"], logs, computer_update_args
        ...
        return prediction, actions, logs, computer_update_args
